 ...
 <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data"  action="http://localhost/Web4_Projects/index.php/Online_Shoping_System_Controller/save_update/<?php echo $UpdateUser[0]['_id']; ?>">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" type="text" name="name"  class="form-control col-md-7 col-xs-12" value="<?php echo $UpdateUser[0]['Name']; ?>">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  name="lname" type="text" class="form-control" value="<?php echo $UpdateUser[0]['LastName']; ?> " >
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="file"  name="Image" required="required"
                                           class="form-control col-md-7 col-xs-12" value="<?php echo $UpdateUser[0]['Image']; ?>" >
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text"  name="phone" required="required"
                                           class="form-control col-md-7 col-xs-12" value="<?php echo 
                                           $UpdateUser[0]['Mobile']; ?> ">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" id="number" name="email" required="required"
                                            class="form-control col-md-7 col-xs-12" value="<?php echo $UpdateUser[0]['Email']; ?>">
                                </div>
                            </div>
                                                        <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="number" name="uname" required="required"
                                            class="form-control col-md-7 col-xs-12" value="<?php echo $UpdateUser[0]['UserName']; ?>" >
                                </div>
                            </div>
                                                        <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" id="number" name="pwd" required="required"
                                            class="form-control col-md-7 col-xs-12" value="<?php echo $UpdateUser[0]['Password']; ?>" >
                                </div>
                            </div>
