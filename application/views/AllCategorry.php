                            ...
                            <tbody>
                               ...
                               foreach ($categories as $category): ?>
                                ...
                                <tr>
                                   ...
                                   <td>  <?php echo anchor('Online_Shoping_System_Controller/delete_category/'.$category['_id'],"<span  class='btn btn-danger glyphicon glyphicon-trash'></span>",array('onclick'=>"return confirm('آیا شما مطمئن هستید که حذف شود؟')"));?></td>
                                </tr>
                                 <?php  endforeach ?>
                                                     <?php else: ?>
                        <center><h5 style="margin: 20px;width:40%" class="alert alert-warning">کدام کتگوری  تا به حال ثبت نشده!</h5></center>
                    <?php endif ?>
                            </tbody>
                        </table>
                    </div>
