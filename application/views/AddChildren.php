        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" action="<?= base_url('index.php/Online_Shoping_System_Controller/create_chaildren'); ?>" >

                            <p>استفاده کننده گرامی لطف نموده اطلاعات مربوط به کالای  که می خواهید اضافه کنید در فورم پائین درج کنید.</p>
                            <span class="section">اضافه کردن محصول طفلانه</span>
