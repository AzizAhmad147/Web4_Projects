...
function searchName(){
    ...
    xmlhttp.open("GET", "Online_Shoping_System_Controller/search_name?name="+document.form1.fname.value,false);
    xmlhttp.send(null);
    document.getElementById("search_table").innerHTML=xmlhttp.responseText;
}
$(document).ready(function(e) {
            $.ajaxSetup({cache:false});
            $('#search_table').load('Online_Shoping_System_Controller/display_info');
        });